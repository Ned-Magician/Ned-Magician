...
- ## 🚀 Direct links to My Projects:
 ...
 [ 11. A modern React application built with Redux, React Router, Tailwind CSS, Context API, and Hooks.  
Features a custom navigation and routing system with a clean, responsive UI.](https://github.com/Ned-Magician/location-search.git) [Vercel 
